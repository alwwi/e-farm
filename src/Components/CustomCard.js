...
export default class customCard extends Component {
  render() {
    return (
      <div className='mt-5 d-flex mx-5 mb-4'>
        <Stack direction="horizontal" gap={5}>

      <>
        <Card className='bg-card txt-poppins-medium' style={{ width: '255px', height:'352px', fontSize:'12px',textAlign:'justify',position:'relative',overflow:'visible',borderRadius:'30px' }}>
